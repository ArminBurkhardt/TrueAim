...
public class RecoilPattern {
    ...
    private static final Vector2f[] AK47_PATTERN = {
            new Vector2f(0.0f, 0.8f),  // Schuss 1: Hauptsächlich vertikal
            new Vector2f(0.3f, 0.7f),  // Schuss 2: Rechts + oben
            new Vector2f(0.5f, 0.6f),  // Schuss 3: Stärker rechts
            new Vector2f(0.4f, 0.5f),  // Schuss 4: Weniger vertikal
            new Vector2f(0.2f, 0.4f),  // Schuss 5: Zentriert sich
            new Vector2f(-0.1f, 0.3f), // Schuss 6: Leicht links
            new Vector2f(-0.4f, 0.2f)  // Schuss 7: Stärker links
    };
